    ...
    hookaddress = function()
        ...
        gg.searchNumber("0.03333333507~0.033999;1.0F;-1D;1D::269", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, cpoint, cpoint + 0x50FFFFF, 1)
    ...
    drawcandle = function()
        ...
        gg.clearResults()
        gg.setRanges(ranges)
        gg.searchNumber(1099746509, gg.TYPE_QWORD, false, gg.SIGN_EQUAL, 0, -1, 1)
        if gg.getResultsCount() == 0 then
            gg.alert(text['fail'])
          return os.exit()
        end
    ...
    emitterbarn = function()
        local x = {}
        gg.setRanges(ranges)
        gg.searchNumber("h 43 61 6E 64 6C 65 73 70 61 63 65 42 6C 69 7A 7A", gg.TYPE_BYTE, false, gg.SIGN_EQUAL, daddr, daddr + 0x50FFFFF, 1) --:CandlespaceBlizz
        if gg.getResultsCount() == 0 then
            gg.alert(text['fail'])
          return os.exit()
        end
    ...
    avatarmod = function() --14D5
        ...
        toplayer = gg.getResults(1)[1].address + 0x20000000
        gg.addListItems({{address=toplayer,flags=gg.TYPE_QWORD,name="toplayer"}})
        gg.clearResults()
        
        local av = {}
        gg.clearResults()
        gg.setRanges(ranges)
        gg.searchNumber("100.0F;5.00403682e-42F;0.1F~1.0F;1.0F::65", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, toplayer, toplayer + 0x50FFFFF, 1)
        ...
        gg.clearResults()
        gg.setRanges(ranges)
        gg.searchNumber("1~4.0F;-0.333~9999F;1.25F;1.0F::109", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, avamod, avamod + 0x50FFFFF, 1)
        if gg.getResultsCount() == 0 then
            gg.alert(text['fail'])
          return os.exit();
        end
    ...
    drawdaily = function()
        ...
        gg.clearResults()
        gg.setRanges(ranges)
        gg.searchNumber("1.0F;1.0F;1D;2D;3D;4D:97", gg.TYPE_DWORD, false, gg.SIGN_EQUAL, cpoint, cpoint + 0x1FFFFFF, 1)
    ...
    unlclothes = function() -- basically no idea
        gg.clearResults()
